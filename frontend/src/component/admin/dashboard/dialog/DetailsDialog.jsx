...
export default function DetailsDialog() {
    const { isViewRecentOrderDetails: isDetailsDialogOpen, setIsViewRecentOrderDetails: setDetailsDialogOpen, selectedRecentOrder: selectedOrderDetails } = useDashboardContext();
